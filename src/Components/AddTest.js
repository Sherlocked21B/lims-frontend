                    ...
                    components={{
                        Toolbar: props => (
                          <div>
                            ...
                            <div style={{padding: '0px 10px'}}>
                              ...
                              <Chip label={addTest.testName} color="secondary" style={{marginRight: 50}}/>
                              <Chip label="Test Amount" color="primary" style={{marginRight: 5}}/>
                              <Chip label={addTest.testAmount} color="secondary" style={{marginRight: 5}}/>
                            </div>
                          </div>
                        ),
                      }}
                      editable={{
                          ...
                          new Promise ( (resolve, reject) =>{
                            ...
                            const filterdParameter = parameter.filter(item=>item.parameters !== name);
